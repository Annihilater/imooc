...
class ModelFormAdminView(ModelAdminView):
    ...
    def change_message(self):
        ...
        if self.org_obj is None:
            ...
            change_message.append(
                _("Changed %s.") % get_text_list(self.form_obj.changed_data, _("and"))
            )
    ...
    def get_media(self):
        try:
            ...
            m = Media()
        return (
            super(ModelFormAdminView, self).get_media()
            + m
...
class CreateAdminView(ModelFormAdminView):
    ...
    def get_response(self):
        ...
        return TemplateResponse(
            self.request,
            self.add_form_template or self.get_template_list("views/model_form.html"),
            context,
        )
...
class UpdateAdminView(ModelFormAdminView):
    ...
    def get_response(self, *args, **kwargs):
        ...
        return TemplateResponse(
            ...
            or self.get_template_list("views/model_form.html"),
            context,
        )
    ...
    def post_response(self):
        ...
        if "_continue" in request.POST:
            ...
            if "_redirect" in request.POST:
                ...
                if (
                    "LIST_QUERY" in self.request.session
